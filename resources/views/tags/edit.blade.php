    ...
    <tbody>  
        <tr class="bg-gray-100 border-b">
            ...
            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                <input name="name" value="{{ $tag->name }}" class="p-2 rounded-lg border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" autofocus>
